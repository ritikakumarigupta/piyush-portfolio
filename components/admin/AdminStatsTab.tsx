...
import { Star, BarChart3, Sparkles, Award } from 'lucide-react';
...
export default function AdminStatsTab({
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="max-w-3xl bg-neutral-900/60 border border-neutral-800/80 p-8 rounded-3xl backdrop-blur-xl shadow-2xl">
        ...
        <form onSubmit={onSaveStats} className="space-y-6 mt-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-3 text-sm bg-neutral-950/80 border border-neutral-800 rounded-xl text-white focus:outline-none focus:border-blue-500 transition-colors"
                placeholder="e.g. 4.8x Avg Retention"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={isSaving}
            className="px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold uppercase tracking-wider shadow-lg shadow-blue-500/20 transition-all cursor-pointer disabled:opacity-50"
          >
