...
export default function Hero({ onPlayShowreel, stats, videos = [] }: HeroProps) {
  ...
  return (
    <section className="relative pt-4 pb-14 sm:pt-8 sm:pb-20 md:pt-10 md:pb-24 overflow-hidden">
      
      {/* Background Ambient Glow Orbs */}
      <div className="absolute top-10 left-1/2 -translate-x-1/2 w-[700px] h-[450px] glow-theme-orb rounded-full blur-[140px] pointer-events-none -z-10 opacity-30"></div>

      <div className="max-w-7xl mx-auto px-3.5 sm:px-6 lg:px-8">
        
        {/* TOP STATUS PILL */}
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/[0.04] border border-white/[0.1] backdrop-blur-md shadow-2xl">
            <span className="flex h-2 w-2 relative">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
            </span>
            <span className="text-[11px] sm:text-xs font-semibold text-neutral-200">
              Open for High-Impact Projects • 100% Free Creative Consultation
            </span>
          </div>
        </div>

        {/* 1. BEHANCE SIGNATURE TYPOGRAPHIC BANNER WITH CUTOUT PORTRAIT */}
        <div className="relative w-full max-w-5xl mx-auto mb-14 sm:mb-20 pt-4 sm:pt-8 flex flex-col items-center justify-center text-center">
          
          {/* Big Bold Typography "PORTFOLIO" Behind */}
          <div className="relative w-full flex items-center justify-center select-none overflow-hidden py-4">
            <span className="text-[68px] xs:text-[90px] sm:text-[140px] md:text-[180px] lg:text-[210px] font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-white/30 via-white/10 to-transparent font-display uppercase leading-none opacity-90 transition-all">
              PORTFOLIO
            </span>

            {/* Glowing Accent Ring behind portrait */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 sm:w-80 h-48 sm:h-80 rounded-full glow-theme-orb blur-2xl -z-10 opacity-60"></div>

            {/* Front Portrait Image Layer */}
            <div className="absolute inset-x-0 bottom-0 flex justify-center items-end pointer-events-none z-10">
              <div className="relative w-48 sm:w-72 md:w-84 aspect-[3/4] max-h-[260px] sm:max-h-[380px] md:max-h-[440px]">
                <img
                  src="/images/piyush-portrait.jpg"
                  alt="Piyush Kumar Gupta"
                  className="w-full h-full object-cover object-top drop-shadow-[0_20px_35px_rgba(0,0,0,0.9)] [mask-image:linear-gradient(to_bottom,black_75%,transparent_100%)]"
                />
              </div>
            </div>
          </div>

          {/* Subtitle Line Matching Behance Reference */}
          <div className="mt-2 sm:mt-4 z-20 space-y-2">
            <div className="inline-flex items-center gap-2 text-xs sm:text-sm md:text-base font-extrabold tracking-widest uppercase text-theme-primary font-mono">
            ...
            <h2 className="text-xl sm:text-3xl md:text-4xl font-black text-white font-display tracking-tight">
              Piyush Kumar Gupta
            </h2>
          </div>
        ...
        {/* 2. MAIN GRID: Bio & Metrics on Left, Live Video Showcase Carousel on Right */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            ...
            <div className="space-y-3">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-theme-primary/10 border border-theme text-[11px] font-bold text-theme-primary">
                <Sparkles className="w-3.5 h-3.5" />
                <span>Crafting High-Retention Visual Psychology</span>
              </div>
              ...
              <p className="text-xs sm:text-base text-neutral-300 max-w-2xl mx-auto lg:mx-0 font-normal leading-relaxed">
                Specialized in <strong className="text-white font-semibold">AI Commercials, Viral Reels, TikTok Ads, and Mythological/3D CGI Visuals</strong>. Combining retention-engineered hooks, kinetic typography, and Hollywood-grade sound design.
              </p>
            </div>

            {/* Quick Metrics Bar */}
            <div className="grid grid-cols-3 gap-2.5 sm:gap-4 max-w-lg mx-auto lg:mx-0">
              <div className="glass-panel p-3.5 rounded-2xl text-center lg:text-left bg-black/50 border-white/[0.08]">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-start gap-3 pt-2">
              ...
              >
                <span>Read Editor Story &amp; Skills</span>
          ...
          {/* Right Column (5 cols): Live Video Showcase Carousel */}
          <div className="lg:col-span-5 flex flex-col items-center">
            <div className="relative w-full max-w-[290px] sm:max-w-[330px] aspect-9-16 rounded-3xl overflow-hidden bg-black/90 border border-white/[0.15] shadow-[0_25px_70px_-15px_rgba(0,0,0,0.95)] group">
